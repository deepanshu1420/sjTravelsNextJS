export function generateHomePageSchema() {
  return {
    ...
    logo: "https://sjtravelsnext.vercel.app/logo.png",
    ...
    itemListElement: [
      {
        ...
        item: {
          ...
          offers: {
            ...
            url: "https://sjtravelsnext.vercel.app/swift-dzire",
          },
        },
      },
      {
        ...
        item: {
          ...
          offers: {
            ...
            priceValidUntil: "2025-12-31",
            availability: "https://schema.org/InStock",
            url: "https://sjtravelsnext.vercel.app/vehicles/toyota-innova",
          },
        },
      },
    ],
...
export function generateTemplePageSchema() {
  return {
    ...
    url: "https://sjtravelsnext.vercel.app/temples/tirumala-temple",
    address: {
      "@type": "PostalAddress",
